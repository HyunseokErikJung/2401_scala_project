...
```sh
git clone git@github.com:HyunseokErikJung/2401_scala_project.git
cd 2401_scala_project
```
...
#### Commit your changes
```sh
git commit -m 'Starting 2401_scala_project'
